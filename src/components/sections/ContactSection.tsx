      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Have questions or ready to discuss your project? We're here to help you achieve your digital transformation goals.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">contact@fwaip.com</p>
                </div>
              </div>
          ...
          >
            ...
            <ContactForm source="ContactSection" ctaText="Send Message" />
          </motion.div>
        </div>
      </div>
    </section>
